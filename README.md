...
абстрактный класс TypeScript с именем `Component` и универсальным типом `T`. \
Вот разбивка того, что делает класс и его методы

    protected constructor(protected readonly container: HTMLElement) - Конструктор корневого DOM элемент
```
...
______________________________________________________________________________________________________________________________________
 ...
 Класс отражающий полный функционал приложения
